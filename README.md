...
| 🎞️ **16:9 寬螢幕** | 1920x1024 | 桃布、橫幅、YouTube | ❌ 不支持 | ✅ 支持 |
...
| 功能 | FLUX.2 Pro | FLUX.2 Flex | FLUX.2 Dev |
|------|-----------|------------|----------|
| **品質** | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐⭐ |
| **速度** | 20-40秒 | 15-30秒 | 15-30秒 |
| **尺寸選擇** | ❌ 僅 1:1 | ✅ 7種比例 | ✅ 7種比例 |
| **API 參數** | 簡化版 | 完整版 | 完整版 |
| **適用場景** | 商業用途 | 快速預覽 | 開發測試 |
| **文字渲染** | 🏆 最佳 | ✅ 優秀 | ✅ 優秀 |
| **width/height** | ❌ 不支持 | ✅ 支持 | ✅ 支持 |
| **steps/seed** | ❌ 不支持 | ✅ 支持 | ✅ 支持 |
...
### FLUX.2 Flex/Dev 支持的參數
✅ 支持完整參數:
- `model`: 模型名稱
- `width`: 圖像寬度 (768-1920)
- `height`: 圖像高度 (768-1920)
- `steps`: 生成步數 (30 推薦)
- `seed`: 隨機種子
- `disable_safety_checker`: 繞過安全檢查
